...
class EconomicCalendar:
    def __init__(self):
        ...
        self.events = [
            # Hardcoded Critical Events for "Sniper" Logic (UTC Time approx - Adjust as needed)
            # Example: US CPI (Unemployment) usually 13:30 UTC
            {"time": "13:30", "currency": "USD", "impact": "HIGH", "name": "CPI / Core Inflation"},
            {"time": "13:30", "currency": "USD", "impact": "HIGH", "name": "Non-Farm Payrolls (NFP)"},
            {"time": "19:00", "currency": "USD", "impact": "HIGH", "name": "FOMC Statement"},
            {"time": "19:30", "currency": "USD", "impact": "HIGH", "name": "FOMC Press Conference"},
            
            # Indian Market (IST 14:30 approx for some RBI policy)
            {"time": "14:30", "currency": "INR", "impact": "HIGH", "name": "RBI Monetary Policy"},
        ]
